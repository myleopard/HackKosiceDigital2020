...
if __name__ == "__main__":
  ...
  # Change to 'True' to save to Google Cloud
  # Won't work on your computers- see mysql.py
  # Will need to change code to access Google instead of local database- will do in morning probs
  if False:
    import mysql # see mysql.py

    # Save to Google Cloud
    mysql.createTables()
    for (_, col) in goodsLog.iterrows():
      mysql.insert(
        col["Index #"],
        col["Quantity"],
        col["Timestamp"],
